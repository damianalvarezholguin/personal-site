...
const $$Index = createComponent(($$result, $$props, $$slots) => {
  ...
  return renderTemplate`<html lang="es"> <head>${renderComponent($$result, "BaseHead", $$BaseHead, { "title": "Home", "description": "Damian Alvarez portfolio", "url": canonical, "noIndex": "true", "img": ogImage })}${renderHead()}</head> <body> <h1>Hello World</h1> </body></html>`;
